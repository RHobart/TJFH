...
class DataWranglingScript extends BaseDataWranglingScript with IDataWranglingScript {
  override def executeScript(): Unit = {
    ...
    if(is_current == "true"){
      ...
      println(s"==============tm>='$collect_tm'  and  (data_source is null or data_source in('dzp_sq','lk')) delete finish")
      ...
      println(s"==============tm>='$start_tm' and tm<'$end_tm'  and  (data_source is null or data_source in('dzp_sq','lk'))  delete finish")
